...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-gamp6kg.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-gamp6kg.containers.anotherwebservice.com/
...
```
git clone git@github.com:3bdomo/container-gamp6kg.git
cd container-gamp6kg
```
...
```
docker attach container-gamp6kg
```
